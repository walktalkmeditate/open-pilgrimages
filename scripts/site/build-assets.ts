 ...
 * at the target path. Route detail pages are hand-authored, and one of them —
 * docs/shikoku-88.html — still carries an id that later becomes a pilgrimage
 * id, as docs/kumano-kodo.html did until it moved aside; without this the
 * generator would overwrite a 24 KB hand-written page with a 5 KB list and
 * the loss would only surface on the next CI step, in a message telling the
 * maintainer to commit the result.
 */
